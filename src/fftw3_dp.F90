!=======================================================================
! FFTW3 double-precision Fortran wrapper (libfftw3)
!=======================================================================
...
END MODULE FFTW3_DP_M


!=======================================================================
! Public API subroutines for libfftw3
!=======================================================================
...
FUNCTION fftw_alloc_complex(N) RESULT(PTR)
  USE ISO_C_BINDING, ONLY: C_PTR, C_SIZE_T
  USE FFTW3_DP_M, ONLY: c_malloc
  INTEGER(C_SIZE_T), INTENT(IN) :: N
  TYPE(C_PTR) :: PTR
  PTR = c_malloc((N + 1) * 16_C_SIZE_T)
END FUNCTION fftw_alloc_complex

SUBROUTINE fftw_free(P)
  USE ISO_C_BINDING, ONLY: C_PTR
  USE FFTW3_DP_M, ONLY: c_free

...
!
      INTEGER(KIND=4) :: N
      INTEGER(KIND=4) :: I,IFAC,IL,IXXX,K,BFAX,NHL,NIL,NFAX,NU
      REAL(KIND=4) :: ANGLE,DEL
      REAL(KIND=4) :: TRIGS(N)
      INTEGER(KIND=4) :: IFAX(*)
      INTEGER(KIND=4) :: JFAX(10),NLFAX(7)
!
...
!
      IXXX=1
!
      DEL=4.0E0_4*ASIN(1.0E0_4)/REAL(N,KIND=4)
      NIL=0
      NHL=(N/2)-1
      DO 10 K=NIL,NHL
      ANGLE=REAL(K,KIND=4)*DEL
